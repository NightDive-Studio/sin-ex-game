...
debugline_t *DebugLines = nullptr;
...
============
*/
void SelectSpawnPoint(Vector &origin, Vector &angles, edict_t *edict, int *gravaxis, int *startonbike /*###*/)
{
   const char * tname;
   Entity *spot  = NULL;
   Entity *spot2 = NULL;
...
int G_FindClass(int entnum, const char *classname)
{
   ...
   // SINEX_FIXME: efficiency - linear search
