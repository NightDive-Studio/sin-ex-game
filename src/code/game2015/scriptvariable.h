...
//###
extern Event EV_Var_IfFlagSet;
extern Event EV_Var_GetTarget;
extern Event EV_Var_GetWeapon;
//###
...
public:
   ...
   //###
   void                 Var_IfFlagSet(Event *ev);
   void                 Var_GetTarget(Event *ev);
   void                 Var_GetWeapon(Event *ev);
   //###
...
inline void ScriptVariable::Unarchive(Archiver &arc)
{
   name = arc.ReadString();
   value = arc.ReadFloat();
...
inline void ScriptVariableList::Unarchive(Archiver &arc)
{
   int i;
   int num;
   ScriptVariable *var;
