...
void TestStringClass(void)
{
   ...
   str	e(NULL);					// e.len == 0, e.data == "\0"					ASSERT!
   int	i;								// i == ?
   ...
   a = c + NULL;						// a.len == 4, a.data == "test\0"			ASSERT!
   a = "this" + d;					// a.len == 8, a.data == "thistest\0"
   a = NULL + d;						// a.len == 4, a.data == "test\0"			ASSERT!
   a += c;								// a.len == 8, a.data == "testtest\0"
   a += "wow";							// a.len == 11, a.data == "testtestwow\0"
   a += NULL;							// a.len == 11, a.data == "testtestwow\0"	ASSERT!
